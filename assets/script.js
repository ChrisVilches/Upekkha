(() => {
  ...
  var require_b64encode = __commonJS({
    "node_modules/qr-encode/lib/b64encode.js"(exports, module) {
  ...
  var require_byte_array = __commonJS({
    "node_modules/qr-encode/lib/byte-array.js"(exports, module) {
  ...
  var require_math = __commonJS({
    "node_modules/qr-encode/lib/math.js"(exports, module) {
      var QRMath = function() {
  ...
  var require_polynomial = __commonJS({
    "node_modules/qr-encode/lib/polynomial.js"(exports, module) {
      var QRMath = require_math();
      function qrPolynomial(num, shift) {
        ...
        var _num = function() {
          ...
          for (var i = 0; i < num.length - offset2; i += 1) {
  ...
  var require_constants = __commonJS({
    "node_modules/qr-encode/lib/constants.js"(exports, module) {
      var QRMode = {
        MODE_NUMBER: 1 << 0,
        MODE_ALPHA_NUM: 1 << 1,
        MODE_8BIT_BYTE: 1 << 2,
  ...
  var require_bit_buffer = __commonJS({
    "node_modules/qr-encode/lib/bit-buffer.js"(exports, module) {
  ...
  var require_string = __commonJS({
    "node_modules/qr-encode/lib/string.js"(exports, module) {
  ...
  var require_bit_byte = __commonJS({
    "node_modules/qr-encode/lib/bit-byte.js"(exports, module) {
      var QRMode = require_constants().QRMode;
  ...
  var require_rsblock = __commonJS({
    "node_modules/qr-encode/lib/rsblock.js"(exports, module) {
  ...
  var require_gif = __commonJS({
    "node_modules/qr-encode/lib/gif.js"(exports, module) {
      var byteArrayOutputStream = require_byte_array();
      var gifImage = function(width, height) {
        var _width = width;
        var _height = height;
        var _data = new Array(width * height);
        var _this = {};
        _this.setPixel = function(x, y3, pixel) {
          _data[y3 * _width + x] = pixel;
        };
  ...
  var require_qr = __commonJS({
    "node_modules/qr-encode/lib/qr.js"(exports, module) {
      var base64EncodeOutputStream = require_b64encode();
      var byteArrayOutputStream = require_byte_array();
      var QRMath = require_math();
      var qrPolynomial = require_polynomial();
      var constants = require_constants();
      var qrBitBuffer = require_bit_buffer();
      var string = require_string();
      var qr8BitByte = require_bit_byte();
      var QRRSBlock = require_rsblock();
      var gifImage = require_gif();
      var QRMode = constants.QRMode;
      var QRErrorCorrectLevel = constants.QRErrorCorrectLevel;
      var QRMaskPattern = constants.QRMaskPattern;
      module.exports = function() {
        var qrcode = function(typeNumber, errorCorrectLevel) {
          ...
          _this.createImgTag = function(cellSize, margin) {
            ...
            return createImgTag(size, size, function(x, y3) {
              if (min2 <= x && x < max2 && min2 <= y3 && y3 < max2) {
                var c = Math.floor((x - min2) / cellSize);
                var r = Math.floor((y3 - min2) / cellSize);
          ...
          _this.createImgSrc = function(cellSize, margin) {
            ...
            var min2 = margin;
            var max2 = size - margin;
            return createImgSrc(size, size, function(x, y3) {
              if (min2 <= x && x < max2 && min2 <= y3 && y3 < max2) {
                var c = Math.floor((x - min2) / cellSize);
                var r = Math.floor((y3 - min2) / cellSize);
                return _this.isDark(r, c) ? 0 : 1;
        ...
        var createImgTag = function(width, height, getPixel, alt) {
          ...
          for (var y3 = 0; y3 < height; y3 += 1) {
            for (var x = 0; x < width; x += 1) {
              gif.setPixel(x, y3, getPixel(x, y3));
            }
          }
        ...
        var createImgSrc = function(width, height, getPixel, alt) {
          ...
          base64.flush();
          var d3 = "";
          d3 += "data:image/gif;base64," + base64;
          return d3;
          var img = "";
          img += "<img";
          img += ' src="';
  ...
  var require_qr_encode = __commonJS({
    "node_modules/qr-encode/lib/qr-encode.js"(exports, module) {
      var qrcode = require_qr();
      function QR(text, opts) {
        ...
        var qr2 = qrcode(type, level);
        qr2.addData(text);
        qr2.make();
        return qr2.createImgSrc(size, margin);
      }
  ...
  // input.js
  var import_qr_encode = __toESM(require_qr_encode());
  function initSearchModal() {
    ...
    const searchModal = new modal_default(modalElement, options);
  ...
  function genQrSingle(selector, container) {
    ...
    element.src = (0, import_qr_encode.default)(content, { type: 6, size: 6, level: "Q" });
  }
