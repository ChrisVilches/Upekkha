<form role="search" method="get" action="<?php echo home_url('/'); ?>">
  ...
  <div class="flex items-center space-x-2">
    <button type="submit" class="grow md:grow-0 py-2.5 px-5 font-medium text-gray-100 focus:outline-none bg-slate-800 hover:bg-slate-900 border border-slate-950 duration-200 transition-colors rounded-lg focus:ring-4 focus:ring-gray-100">Search</button>
    <? if ($args['close-btn']) : ?>
